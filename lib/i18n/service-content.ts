...
const CAPABILITIES: LocaleRecord<string[][]> = {
  en: [
    [
  ...
  he: [
    [
      "מוצרי SaaS ופלטפורמות רב־דייריות",
      "דשבורדי ניהול ופורטלי לקוחות",
      "מערכות תפעול פנימיות",
      "מסחר אלקטרוני וניהול הזמנות",
      "אימות, RBAC ומודלי נתונים",
    ],
    [
      "אתרים ארגוניים ותיקי עבודות",
      "דפי נחיתה וקליטת לידים",
      "חנויות אונליין",
      "ארכיטקטורה מוכנה ל־SEO",
      "אינטגרציות CMS ותחזוקה",
    ],
    [
      "קופיילוטים ואוטומציית תהליכים",
      "אינטגרציות LLM וחכמת מסמכים",
      "דשבורדי BI מותאמים",
      "צינורות ETL ותשתיות נתונים",
      "מערכות לתמיכה בהחלטות",
    ],
    [
      "הקמת Meta / Google / TikTok",
      "פיקסל ומעקב המרות",
      "צינורות הפקה קריאייטיבית",
      "הקמת CRM וזרימת לידים",
      "מבני דיווח חודשיים",
    ],
    [
      "רנדרים פנים וחוץ",
      "מידול תלת־ממד מתוכניות דו־ממד",
      "סיורים וירטואליים",
      "תצוגות Three.js ו־WebGL",
      "חבילות רנדר לרשתות חברתיות",
    ],
    [
      "הגדרת היקף טכני ומפת דרכים ל־MVP",
      "ארכיטקטורת מערכת ומודלי נתונים",
      "תעדוף פיצ׳רים",
      "אחסון, פריסה וניטור",
      "תחזוקה ואיטרציה שוטפת",
    ],
  ],
};

const CAPABILITIES_FULL: LocaleRecord<string[][]> = {
  en: [
  ...
  he: [
    ["מוצרי SaaS ראשוניים", "פלטפורמות רב־דייריות", "תוכנה לייצור בדפדפן", "דשבורדי ניהול", "פורטלי לקוחות", "מערכות תפעול פנימיות", "כלי אוטומציית תהליכים", "מערכות אימות ו־RBAC", "חנויות אונליין", "ארכיטקטורת קטלוג מוצרים", "עגלת קניות, תשלום וצ׳ק־אאוט", "חשבונות לקוח וניהול הזמנות", "אבטיפוסי מוצר", "מערכות תחזוקה"],
    ["דפי נחיתה", "אתרים ארגוניים", "אתרי תיק עבודות", "אתרי בריאות", "אתרי סטודיו ואדריכלות", "חנויות אונליין", "עמודים מוכנים ל־SEO", "אינטגרציות CMS", "דפי המרה", "הקמת אנליטיקס", "תחזוקה ועדכוני תוכן", "אופטימיזציית ביצועים"],
    ["קופיילוטים ועוזרי AI", "אינטגרציות LLM API", "צינורות אוטומציה", "חכמת מסמכים", "כלי AI לווידאו ומדיה", "עוזרי מחקר", "דשבורדים לתמיכה בהחלטות", "הנדסת פרומפטים וכיוונון", "דשבורדי BI מותאמים", "ETL וצינורות נתונים", "קונסולים למנהלים", "כלי דיווח תפעולי", "דשבורדים גיאו־מרחביים", "ממשקי מודיעין שוק וסיכון", "איחוד נתונים ממקורות מרובים", "דיווח לפי תפקיד", "ייצוא והפקת דוחות"],
    ["הקמת Meta / Google / TikTok", "יישום מעקב ופיקסל", "הקמת CRM וזרימת לידים", "דפי נחיתה להמרה", "דשבורדי קמפיין", "מבנה UTM", "תכנון ואסטרטגיית קמפיין", "צינור הפקה קריאייטיבית", "תהליכי פוסט־פרודקשן", "לוחות תוכן למותג", "חבילות נכסים לרשתות", "צינור QA", "פורמטי מסירה", "דיווח ביצועים חודשי", "הדרכת לקוח ומסירה"],
    ["רנדרים פנים וחוץ", "מידול תלת־ממד מתוכניות דו־ממד", "סיורים וירטואליים", "תצוגות Three.js באתר", "סצנות WebGL וקונפיגורטורים", "ויזואלים למכירת נדל״ן", "חבילות רנדר לרשתות", "עמודי תיק עבודות ופרויקטים", "ויזואליזציית מטבחים וחללים", "הצגת לפני/אחרי", "גלריות רנדר משובצות", "מציגי מוצר תלת־ממדיים אינטראקטיביים"],
    ["אודיט פרויקט", "דרישות מוצר", "תעדוף פיצ׳רים", "הגדרת היקף MVP", "ארכיטקטורה טכנית", "זרימות משתמש", "תכנון מודל נתונים", "תכנון אינטגרציות", "מפת דרכים למסירה", "הערכת עלות ולוח זמנים", "הקמת אחסון", "ניטור פריסה", "תיקוני באגים ועדכוני אבטחה", "עדכוני תוכן", "דיווח אנליטיקס", "שיפורים חודשיים", "גיבוי ושחזור", "אופטימיזציית ביצועים", "תהליך QA", "הדרכה ומסירה"],
  ],
};
