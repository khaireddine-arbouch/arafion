...
const PRIVACY: LocaleRecord<LegalPageContent> = {
  en: {
  ...
  he: {
    topBar: "מדיניות פרטיות",
    eyebrow: "משפטי",
    title: "מדיניות פרטיות",
    intro: "שומרים על זה קצר וברור. הנה מה שאנחנו אוספים, למה, ומה עושים עם זה.",
    effective: "1 בינואר 2026",
    footerQuestions: "שאלות?",
    footerHome: "בית",
    footerOtherLabel: "תנאי שימוש",
    footerOtherHref: "/terms",
    sections: [
      { title: "1. מי אנחנו", body: "{brand} הוא סטודיו להנדסת מוצר שמספק פיתוח תוכנה, מערכות AI, תשתיות נתונים ומערכות דיגיטליות. מדיניות זו מסבירה כיצד מטפלים במידע שנאסף דרך האתר ובמהלך התקשרויות שירות. יצירת קשר: contact@arafion.com." },
      { title: "2. מידע שאנחנו אוספים", body: "אנחנו אוספים מידע שאתם מוסרים מרצונכם — שם, אימייל, שם חברה ופרטי פרויקט — כשפונים דרך דף יצירת הקשר או במייל. אין חשבונות משתמש באתר ואין איסוף ישיר של פרטי תשלום." },
      { title: "3. כיצד אנחנו משתמשים במידע", body: "פרטי יצירת קשר משמשים אך ורק למענה לפנייה, לדיון בפרויקט ולתקשורת סביב התקשרות. איננו מוכרים או משתפים מידע אישי עם צדדים שלישיים למטרות שיווק." },
      { title: "4. עוגיות ומעקב", body: "האתר עשוי להשתמש בעוגיות חיוניות לתפקוד בסיסי. אין עוגיות פרסום ואין מעקב בין־אתרים." },
      { title: "5. נתוני פרויקט של לקוחות", body: "נתוני פרויקט מטופלים כסודיים לחלוטין. אין שיתוף חומרי לקוח עם צדדים שלישיים למעט קבלני משנה תחת התחייבויות סודיות." },
      { title: "6. אחסון ואבטחה", body: "מידע שנשלח במייל או בטופס נשמר במערכות שלנו אצל ספקי ענן מוכרים. נוקטים באמצעי זהירות סבירים, אך אין העברה באינטרנט מאובטחת ב־100%." },
      { title: "7. שירותי צד שלישי", body: "האתר עשוי לקשר לאתרים חיצוניים. ברגע שעוזבים את arafion.com מדיניות זו אינה חלה עוד." },
      { title: "8. הזכויות שלכם", body: "ניתן לבקש גישה, תיקון או מחיקה של מידע אישי בפנייה ל־contact@arafion.com. נשיב תוך זמן סביר." },
      { title: "9. פרטיות ילדים", body: "האתר אינו מיועד לילדים מתחת לגיל 16. איננו אוספים ביודעין מידע מקטינים." },
      { title: "10. שינויים במדיניות זו", body: "ייתכן שנעדכן מדיניות זו מעת לעת. המשך שימוש באתר לאחר עדכון מהווה הסכמה למדיניות המעודכנת." },
      { title: "11. יצירת קשר", body: "לשאלות פרטיות: contact@arafion.com. אנו שואפים להשיב תוך שני ימי עסקים." },
    ],
  },
};

const TERMS: LocaleRecord<LegalPageContent> = {
  en: {
    topBar: "Terms of Use",
    eyebrow: "Legal",
    title: "Terms of Use",
  ...
  he: {
    ...
    eyebrow: "משפטי",
    title: "תנאי שימוש",
    intro: "תנאים אלה חלים על השימוש באתר זה ועל כל התקשרות עם {brand} לשירותים. אנא קראו אותם בעיון.",
    effective: "1 בינואר 2026",
    footerQuestions: "שאלות?",
    footerHome: "בית",
    footerOtherLabel: "מדיניות פרטיות",
    footerOtherHref: "/privacy-policy",
    sections: [
      { title: "1. קבלת התנאים", body: "בגישה ל־arafion.com או בהתקשרות עם {brand} לכל שירות — אתם מסכימים לתנאי שימוש אלה. אם אינכם מסכימים, אל תשתמשו באתר או בשירותים." },
      { title: "2. השירותים הניתנים", body: "{brand} מספק הנדסת תוכנה, פיתוח אתרים, מוצרי AI, מערכות נתונים ושירותים דיגיטליים נלווים. היקף, מסירות, לוח זמנים ותנאי תשלום מוגדרים בהסכם בכתב נפרד." },
      { title: "3. קניין רוחני", body: "לאחר תשלום מלא, הלקוחות מקבלים בעלות על המסירות הסופיות כפי שמפורט בהסכם. {brand} שומר בעלות על מסגרות בסיס, רכיבים לשימוש חוזר ו־know-how." },
      { title: "4. אחריות הלקוח", body: "הלקוחות אחראים לבריפים מדויקים, משוב בזמן, נכסים נדרשים ואישורים. עיכובים מצד הלקוח עלולים להשפיע על לוח הזמנים." },
      { title: "5. תשלום", body: "תנאי התשלום מוגדרים לכל התקשרות. בדרך כלל נדרשת מקדמה לפני תחילת העבודה, עם תשלומי אבני דרך לפי שלבי מסירה." },
      { title: "6. סודיות", body: "שני הצדדים מסכימים לשמור בסוד מידע שאינו ציבורי ששותף במהלך ההתקשרות." },
      { title: "7. אחריות והצהרות הסתייגות", body: "{brand} מתחייב שהשירותים יבוצעו באופן מקצועי ובהתאם למפרט המוסכם. האתר מסופק כפי שהוא (as is)." },
      { title: "8. הגבלת אחריות", body: "במידה המרבית המותרת בדין, אחריות {brand} מוגבלת לסכומים ששולמו עבור הפרויקט הספציפי." },
      { title: "9. סיום", body: "כל צד רשאי לסיים הסכם פרויקט בהודעה בכתב כפי שמפורט באותו הסכם." },
      { title: "10. דין חל", body: "תנאים אלה כפופים לדיני השיפוט שבו {brand} רשום, ללא התחשבות בכללי ברירת הדין." },
      { title: "11. שינויים בתנאים אלה", body: "{brand} רשאי לעדכן תנאים אלה בכל עת. המשך שימוש לאחר שינוי מהווה הסכמה לתנאים המעודכנים." },
      { title: "12. יצירת קשר", body: "שאלות לגבי תנאים אלה: contact@arafion.com. אנו שואפים להשיב תוך שני ימי עסקים." },
    ],
  },
};

export function getPrivacyContent(locale: Locale) {
  return applySiteCopy(PRIVACY[locale] ?? PRIVACY.en);
}

export function getTermsContent(locale: Locale) {
  return applySiteCopy(TERMS[locale] ?? TERMS.en);
}
