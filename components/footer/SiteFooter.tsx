...
const technicalOnly = isTechnicalOnlySite(site.id);
...
function socialIconFor(label: string) {
  return label.toLowerCase().includes("instagram") ? INSTAGRAM_ICON : LINKEDIN_ICON;
}
...
export default function SiteFooter() {
  ...
  const socialNavLinks: FooterLink[] = site.socialLinks.map((s) => ({
    title: s.label,
    href: s.href,
    external: true,
  }));
  ...
  const NAV: { label: string; links: FooterLink[] }[] = [
    {
      label: columns.site,
      links: [
        { title: links.home, href: "/" },
        { title: links.about, href: "/about" },
        { title: links.services, href: "/services" },
        { title: links.work, href: "/work" },
        { title: links.blog, href: "/blog" },
        { title: links.contact, href: "/contact" },
        { title: links.faq, href: "/#faq" },
      ],
    },
    {
      label: columns.capabilities,
      links: [
        { title: links.softwareSaas, href: "/services#software" },
        { title: links.websitesDigital, href: "/services#websites" },
        { title: links.dashboardsIntelligence, href: "/services#intelligence" },
        ...(!technicalOnly
          ? [
              { title: links.marketingSystems, href: "/services#marketing" },
              { title: links.architecture3d, href: "/services#visualization" },
            ]
          : []),
        { title: links.strategyScoping, href: "/services#strategy" },
        { title: links.projectAudit, href: "/services#audit" },
      ],
    },
    {
      label: columns.demos,
      links: [
        { title: links.allProjects, href: "/work" },
        { title: links.caseStudies, href: "/#case-studies" },
    ...
    },
    {
      label: columns.legal,
      links: [
        { title: links.privacy, href: "/privacy-policy" },
        { title: links.terms, href: "/terms" },
        { title: links.emailUs, href: `mailto:${site.email}` },
        ...socialNavLinks,
      ],
    },
  ];
        ...
        <div className="flex flex-col gap-4 py-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
            <span style={{ fontFamily: NM, fontWeight: 400, fontSize: "11.5px", color: "rgba(255,255,255,0.22)" }}>
              &copy; {YEAR} {site.shortName}. {t.footer.copyright}
            </span>
            <Link
              href="/privacy-policy"
