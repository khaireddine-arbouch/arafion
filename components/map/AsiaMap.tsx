...
import { ASIA_MAP_PROJECTS } from "@/lib/map-projects";
    ...
    >
      ...
      >
        ...
        {showMapPins && onHoverFacility && onLeaveFacility && (
          <MapProjectDots projection={asiaProjection as unknown as (c: [number, number]) => [number, number] | null}
            projects={ASIA_MAP_PROJECTS}
