...
import { EU_MAP_PROJECTS } from "@/lib/map-projects";
    ...
    >
      ...
      >
        ...
        {showMapPins && onHoverFacility && onLeaveFacility && (
          <MapProjectDots projection={euProjection as unknown as (c: [number, number]) => [number, number] | null}
            projects={EU_MAP_PROJECTS}
